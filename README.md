 ...
 * **tidy1.txt** - Consolidated dataset with clean variable names, merging X,Y and subject components containing only mean and standard deviation measurements 
 * **tidy2.txt** - Second, independent tidy data set with the average of each variable for each activity and each subject. 
